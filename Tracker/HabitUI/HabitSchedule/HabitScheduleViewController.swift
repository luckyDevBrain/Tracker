...
/// Контроллер для настройки расписания привычки
...
private extension HabitScheduleViewController {
    func createScheduleStackView() -> CircularViewsStackView {
        ...
        let stack = CircularViewsStackView(arrangedSubviews: arrangedSubviews)
        stack.translatesAutoresizingMaskIntoConstraints = false
        return stack
    }

    func createOkButton() -> CircularButton {
        let button = CircularButton(title: "Готово")
